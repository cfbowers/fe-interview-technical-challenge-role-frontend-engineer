...
const policyholdersEndPoint = "https://fe-interview-technical-challenge-api-git-main-sure.vercel.app/api/policyholders";

export const fetchPolicyHolders = () =>
  fetch(policyholdersEndPoint, { method: "GET" });

export const postPolicyHolder = () => fetch(policyholdersEndPoint, {
  method: 'POST',
  body: JSON.stringify({
